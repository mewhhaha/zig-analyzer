...
**Why it matters.** The published error contract becomes impossible for callers to name or exhaustively switch over. This is API-design guidance enabled by the `strict` profile, not a correctness diagnostic.
