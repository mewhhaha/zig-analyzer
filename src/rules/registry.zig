...
const rule_modules = .{
    ...
    @import("discarded_realloc_result.zig"),
    ...
    @import("ownership_edge_cases.zig"),
    @import("concurrency_hazards.zig"),
    @import("boundary_hazards.zig"),
    @import("io_contract_hazards.zig"),
