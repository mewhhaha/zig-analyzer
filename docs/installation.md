...
Release `0.16.0-3` supports x86_64 Linux and includes the patched compiler
...
```sh
sha256sum --check zig-analyzer-0.16.0-3-x86_64-linux.tar.xz.sha256
tar -xf zig-analyzer-0.16.0-3-x86_64-linux.tar.xz
./zig-analyzer-0.16.0-3-x86_64-linux/bin/zig-analyzer doctor
```
...
mv zig-analyzer-0.16.0-3-x86_64-linux ~/.local/opt/
ln -s ~/.local/opt/zig-analyzer-0.16.0-3-x86_64-linux/bin/zig-analyzer ~/.local/bin/zig-analyzer
```
