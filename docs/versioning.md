...
There is no packaged release yet; build from source as described in the
[installation guide](installation.md). Tagged releases will follow the scheme
above, beginning with `0.16.0-1`.
