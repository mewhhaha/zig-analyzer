...
const EXAMPLES = [
  ...
  },
  {
    ...
    kind: "Completion",
    label: "@Struct",
    title: "A struct reified from a list of names",
    summary:
      "CliFlags exists only after @Struct builds it from flag_names; completion answers with the reified fields.",
    fixture: "examples/compiler/reified_flags.zig",
    displayStart: 0,
    displayEnd: 8,
    completion: { line: 7, after: "flags." },
    requiredAnalyzerCompletions: ["verbose"],
    expectedZlsCompletions: [],
  },
  {
  ...
  },
  {
    ...
    title: "Memory touched after it was given back",
    summary:
      "One function reads through a slice it already freed; another frees the same allocation twice through its defer.",
    fixture: "examples/diagnostics/use_after_release.zig",
    displayStart: 0,
    displayEnd: 19,
    requiredAnalyzerDiagnostics: ["use-after-release", "double-release"],
    expectedZlsDiagnostics: [],
  },
  {
    id: "dangling-slice",
    kind: "Diagnostics",
    label: "dangling slice",
    title: "A slice that outlives its stack frame",
    summary:
      "The returned slice points into an array that dies with the function; the copying variant hands back owned memory instead.",
    fixture: "examples/diagnostics/dangling_slice.zig",
    displayStart: 0,
    displayEnd: 10,
    requiredAnalyzerDiagnostics: ["returning-local-slice"],
    expectedZlsDiagnostics: [],
  },
  {
    id: "helper-release",
    kind: "Diagnostics",
    label: "helper free",
    title: "A release that lives in a helper",
    summary:
      "recycleLine provably frees its argument, so the helper call keeps recycled clean; forgotten has no release anywhere and is reported.",
    fixture: "examples/diagnostics/helper_release.zig",
    displayStart: 0,
    displayEnd: 15,
    requiredAnalyzerDiagnostics: ["unreleased-allocation"],
    expectedZlsDiagnostics: [],
  },
];
